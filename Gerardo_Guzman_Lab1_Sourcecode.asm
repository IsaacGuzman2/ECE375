...
;*	-	9/28/22 Guzman		Added a second wait constant "WTme" to increase reverse time
;***********************************************************
...
.equ	WTme = 200				; Second time to wait loop
...
HitRight:
		...
		ldi		waitcnt, WTme	; Wait for 1 second
...
HitLeft:
		...
		ldi		mpr, MovBck	; Load Move Backward command
		out		PORTB, mpr	; Send command to port
		ldi		waitcnt, WTme	; Wait for 2 seconds
		rcall	Wait			; Call wait function
